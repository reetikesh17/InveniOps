...
export function XCircleIcon({ className = "h-5 w-5" }: IconProps): JSX.Element {
  return (
    <svg viewBox="0 0 20 20" fill="none" className={className} aria-hidden="true">
      <circle cx="10" cy="10" r="8.5" className="stroke-current" strokeWidth="1.5" />
      <path d="M7.5 7.5l5 5m0-5l-5 5" className="stroke-current" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
...
export function ExclamationTriangleIcon({ className = "h-5 w-5" }: IconProps): JSX.Element {
  return (
    <svg viewBox="0 0 20 20" fill="none" className={className} aria-hidden="true">
      <path d="M10 3.5l8 14H2l8-14z" className="stroke-current" strokeWidth="1.5" strokeLinejoin="round" />
...
export function InboxIcon({ className = "h-8 w-8" }: IconProps): JSX.Element {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <path d="M4 12h4l2 3h4l2-3h4" className="stroke-current" strokeWidth="1.5" strokeLinejoin="round" />
      <path
...
export function ClockIcon({ className = "h-3 w-3" }: IconProps): JSX.Element {
  return (
    <svg viewBox="0 0 16 16" fill="none" className={className} aria-hidden="true">
      ...
      <path d="M8 4.5V8l2.5 1.5" className="stroke-current" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function ArchiveIcon({ className = "h-3 w-3" }: IconProps): JSX.Element {
  return (
    <svg viewBox="0 0 16 16" fill="none" className={className} aria-hidden="true">
      <rect x="2" y="3" width="12" height="3" rx="0.5" className="stroke-current" strokeWidth="1.5" />
      <path d="M3 6.5v5.5a1 1 0 001 1h8a1 1 0 001-1V6.5" className="stroke-current" strokeWidth="1.5" />
...
export function ChevronDownIcon({ className = "h-4 w-4" }: IconProps): JSX.Element {
  return (
    <svg viewBox="0 0 16 16" fill="none" className={className} aria-hidden="true">
      <path d="M4 6l4 4 4-4" className="stroke-current" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
