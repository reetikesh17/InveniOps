...
export const EYEBROW_CLASSES = "font-mono text-eyebrow font-medium uppercase tracking-wider text-ink-muted";

/** Brand mark and page H1s — the one place the display face appears. */
export const DISPLAY_HEADING_CLASSES = "font-display text-wordmark font-bold uppercase tracking-[0.14em] text-ink";
...
export const MONO_MICRO_CLASSES = "font-mono text-mono-micro lowercase tracking-tight text-ink-muted";
